        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm md:text-base">
              Test your business visibility across AI platforms
            </p>
          </div>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
          >
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <span>5 free tests per month</span>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div>
                <span>Detailed AI response reports</span>
              </li>
            </ul>
          </div>
        </div>
